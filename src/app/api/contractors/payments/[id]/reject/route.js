...
// PUT: Reject payment (status -> 'Rejected')
export async function PUT(request, { params }) {
  try {
    ...
    console.log("[Reject Route] resolvedParams:", resolvedParams);
    const intId = getIntId(resolvedParams.id);
    console.log("[Reject Route] parsed intId:", intId);
    ...
    console.error("PUT /api/contractors/payments/[id]/reject error:", error);
    return NextResponse.json(
